    ...
    public override void SalvarJogo(Jogo jogo)
{
    ...
    try
    {
        using (var command = new SQLiteCommand(con))
        {
            ...
            var idJogo = (long)command.ExecuteScalar();

            // Adicionar as notas do jogo
            AdicionarNotas(jogo, idJogo);

            // Adicionar as plataformas do jogo
            AdicionarPlataformas(jogo, idJogo);
        }
...
private void AdicionarNotas(Jogo jogo, long idJogo)
{
...
private void AdicionarPlataformas(Jogo jogo, long idJogo)
{
